...
static int ninio37 = 50;
static int TerminalAU37 = 56;
...
static int stack37[8][8] =
    ...
    {{NST, NST, NST, NST, NST, NST, NST, NST},
     {NST, -133, -207, -146, -37, -139, -132, NST},
     {NST, -207, -205, -150, -91, -129, -123, NST},
     {NST, -146, -150, -22, -67, -81, -58, NST},
     {NST, -37, -91, -67, -38, -14, -2, NST},
     {NST, -139, -129, -81, -14, -84, -69, NST},
     {NST, -132, -123, -58, -2, -69, -68, NST},
     {NST, NST, NST, NST, NST, NST, NST, NST}};
...
static int mismatchI37[8][5][5] =
    {
        /* @@ */
        {{90, 90, 90, 90, 90}, {90, 90, 90, 90, -20}, {90, 90, 90, 90, 90}, {90, -20, 90, 90, 90}, {90, 90, 90, 90, 20}},
        {                      /* CG */
         {0, 0, 0, 0, 0},      /* @@  @A  @C  @G  @U */
