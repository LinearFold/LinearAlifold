...
#define TURN 3
#define ILLEGAL_HAIRPIN_SCORE 600;
#define CUBE_PRUNING_SIZE 20
#define SCALE 100
#define MAXLOOP 30
#define INF std::numeric_limits<int>::max()
#define NEG_INF -2e20 
#define MIN_VALUE numeric_limits<int>::lowest()
#define NUM_OF_NUC_TYPES 5
#define NST 0     /* Energy for nonstandard stacked pairs */

#define GET_ACGU_NUM(x) ((x=='A'? 1 : (x=='C'? 2 : (x=='G'? 3 : (x=='U'? 4 : 0)))))

static double lxc37=107.856; /* parameter for logarithmic loop energy extrapolation*/

static int BP_pair[NUM_OF_NUC_TYPES][NUM_OF_NUC_TYPES] =
/* N  A  C  G  U*/
{{ 0, 0, 0, 0, 0},
 { 0, 0, 0, 0, 5},
 { 0, 0, 0, 1, 0},
...
{ {  NST,   NST,   NST,   NST,   NST,   NST,   NST},
  {  NST,  -133,  -207,  -146,   -37,  -139,  -132},
  {  NST,  -207,  -205,  -150,   -91,  -129,  -123},
  {  NST,  -146,  -150,   -22,   -67,   -81,   -58},
  {  NST,   -37,   -91,   -67,   -38,   -14,    -2},
  {  NST,  -139,  -129,   -81,   -14,   -84,   -69},
  {  NST,  -132,  -123,   -58,    -2,   -69,   -68}};
